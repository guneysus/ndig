namespace ndig.Native
{
    ...
    internal static class NativeMethods
    {
        ...
        internal static extern int DnsQuery(string lpstrName, DnsRecordTypes wType, DnsQueryOptions Options, IntPtr pExtra, ref IntPtr ppQueryResultsSet, IntPtr pReserved);
        ...
        internal static extern void DnsRecordListFree(IntPtr pRecordList, DNS_FREE_TYPE FreeType);
    }
}